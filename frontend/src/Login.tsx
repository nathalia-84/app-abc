function Login() {
    return (
        ...
        <div className="hidden lg:block relative w-0 flex-12 bg-gray-900"> 
          <div className="flex h-full justify-center items-center"> 
              <img src="https://www.shutterstock.com/pt/search/abc" alt="abc"/>
          </div>
        </div>
        <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24"> 
          <div className="mx-auto w-full max-w-sm">
            <div>
              <img src="https://www.shutterstock.com/pt/search/abc" alt="" className="lg:hidden h-20 w-auto"/>
